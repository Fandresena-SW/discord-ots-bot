...
*(🟡 006 = docs authored & sanity-tested; live E2E checklist execution, timed
dry-run, and deploy verification are explicitly pending organizer/live-guild
action — see RFC-006's Completion record.)*
